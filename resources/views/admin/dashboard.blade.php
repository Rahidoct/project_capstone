...
<head>
    ...
    <title>Admin | Cirebon Online Store</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @php
                        ...
                        $products = App\Models\Product::select('name', 'price')->get();
                    @endphp
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="row no-gutters align-items-center mt-2">
                                                ...
                                                @endforelse
                                                <div class="col ml-2">
                                                    <div class="text-sm font-weight-bold text-primary">{{ $product->name }}</div>
                                                    <div class="text-xs text-success">Price: ${{ $product->price }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
